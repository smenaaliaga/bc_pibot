...
def _snapshot_agent_state(state: AgentState) -> Dict[str, Any]:
    snapshot: Dict[str, Any] = {
        ...
        "intent_info": copy.deepcopy(state.get("intent_info")),
        "classification": copy.deepcopy(state.get("classification")),
        ...
        "context": copy.deepcopy(state.get("context")) if isinstance(state.get("context"), dict) else None,
