...
def _build_latest_contribution_intro(
    *,
    ...
    llm_prompt = (
        ...
        "- No uses mayúsculas enfáticas en palabras o frases (por ejemplo: 'MENOS APORTÓ', 'RESTÓ', 'DETRAJO').\n"
        ...
        "- Si la pregunta es general sobre contribuciones (ej: 'cuánto contribuyeron los sectores...') y no pide explícitamente 'menor', 'restó' o 'detrajo', prioriza las que MÁS aportaron en orden descendente.\n"
        ...
        "- No menciones que no hubo aportes negativos, salvo que el usuario lo haya preguntado explícitamente.\n"
    ...
    if user_question and isinstance(all_series_data, list) and all_series_data:
        ...
        if variation_candidates:
            ...
            llm_prompt = (
                ...
                "No menciones de nuevo el indicador, el período ni el porcentaje total. Comienza DIRECTAMENTE con el análisis de los componentes.\n"
                "- Responde ÚNICAMENTE lo que el usuario preguntó. NO agregues información que no fue solicitada.\n"
                "- No uses mayúsculas enfáticas en palabras o frases (por ejemplo: 'MENOS CRECIÓ', 'RESTÓ', 'CAYÓ').\n"
                ...
                "  Respeta esta diferencia rigurosamente.\n"
                "- Si la pregunta es general sobre variaciones de componentes y no pide explícitamente 'menor', 'cayó' o 'restó', prioriza las de mayor variación positiva (idealmente top 3) en orden descendente.\n"
                ...
                "- No menciones que no hubo variaciones negativas, salvo que el usuario lo haya preguntado explícitamente.\n"
                "- Si pregunta por las N principales, lista exactamente N, ordenadas.\n"
                "- Usa formato de porcentajes con coma decimal (ej: 1,2%).\n"
                "- Responde en español, de forma concisa (1-2 oraciones máximo).\n"
                "- NO inventes datos; usa solo los valores del listado anterior.\n"
