...
# Reglas post-clasificador centralizadas (predicates + regex).
# Se importan desde rules.post_classifier para mantener un único punto de
# mantenimiento. Los nombres se reexportan a nivel módulo para preservar
# el contrato público de ingest.py.
from rules.post_classifier import (
    _CALENDAR_INTENT_RE,
    _GREETING_RE,
